    ...
    <main className="min-h-screen bg-[#fcfcfb] px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-8">
          ...
          <div className="mt-8 rounded-[1.7rem] border border-slate-200 bg-slate-50 p-6 sm:p-7">
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <p className="text-sm leading-6 text-slate-500">
                로그인 후 후기 열람이 가능하도록 단계별 화면을 먼저 준비해 두었습니다.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_16px_50px_rgba(15,23,42,0.04)] sm:p-10">
          <p className="text-sm font-semibold tracking-[0.16em] text-teal-700 uppercase">Review Login Flow</p>
          <h2 className="mt-4 text-2xl font-bold text-slate-900 sm:text-3xl">
            후기 로그인은 아래 흐름으로 구성할 예정입니다
          </h2>
            ...
            {[
              {
                step: "1",
                title: "후기 페이지 접속",
                description: "진료후기 페이지에서 로그인 버튼이 보이는 화면",
              },
              {
                step: "2",
                title: "로그인 화면 이동",
                description: "이메일과 비밀번호를 입력하는 로그인 페이지로 이동하는 화면",
              },
              {
                step: "3",
                title: "후기 열람 완료",
