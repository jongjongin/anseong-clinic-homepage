...
const sections = [
  {
    ...
    body: [
      ...
      "현재 홈페이지에서는 별도의 일반 회원가입 기능을 제공하지 않으며, 전화 상담 및 외부 상담 채널 연결 과정에서 필요한 정보만 최소한으로 확인합니다.",
      "향후 직접 관리하는 로그인 기능을 통해 진료후기 열람 기능을 운영하는 경우, 후기 보기 목적에 필요한 범위에서만 로그인 정보를 활용할 수 있습니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "로그인 기능을 적용하는 경우 후기 열람을 위한 최소 범위의 회원 식별 정보가 수집될 수 있으며, 실제 운영 시 수집 항목은 별도 고지합니다.",
