...
const sections = [
  {
    ...
    body: [
      ...
      "향후 네이버 로그인을 통해 진료후기 열람 기능을 운영하는 경우, 후기 보기 목적에 필요한 범위에서만 로그인 정보를 활용할 수 있습니다.",
    ],
  },
  {
    ...
    body: [
      ...
      "네이버 로그인 기능을 적용하는 경우 후기 열람을 위한 최소 범위의 회원 식별 정보가 수집될 수 있으며, 실제 운영 시 수집 항목은 별도 고지합니다.",
