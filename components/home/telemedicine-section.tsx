      ...
      <div className="mx-auto max-w-6xl px-4 py-18 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        <Reveal>
          <div className="flex flex-col gap-4">
            ...
            />
            <div className="inline-flex w-fit rounded-full border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-semibold text-amber-700">
              {telemedicineSectionContent.statusBadge}
            </div>
          </div>
        </Reveal>
