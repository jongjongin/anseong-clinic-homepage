          ...
          <Reveal delayMs={100}>
            <div className="mt-8 flex flex-col gap-3 lg:mt-0">
              ...
              <a
                ...
                className="rounded-full border border-slate-300 bg-white px-6 py-4 text-center text-base font-semibold text-slate-900 transition-colors hover:border-slate-900"
              >
