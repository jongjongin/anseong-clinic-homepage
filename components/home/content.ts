...
export const departmentsSectionContent = {
  ...
  items: [
    ...
    {
      title: "보약",
      summary: "체력 저하와 잦은 피로, 회복이 더딘 컨디션을 함께 살핍니다.",
      description:
        "평소 쉽게 지치거나 아프고 난 뒤 회복이 더디다고 느끼는 분들을 위해 현재 몸 상태와 생활 패턴에 맞는 보약 상담을 안내합니다.",
    },
    {
      title: "여성질환",
  ...
  items: [
    ...
    },
    {
      ...
      credentials: [
        ...
        "대한한의학회 정회원",
        "대한스포츠한의학회 준회원",
        "PADI EFR 국제 응급처치 자격증",
        "대한한의사협회 주관 추나교육 수료",
        "세명대학교 부속 제천한방병원 임상과정 수료",
        "세명대학교 부속 충주한방병원 임상과정 수료",
      ],
    },
  ],
};
