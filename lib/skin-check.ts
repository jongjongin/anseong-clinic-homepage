...
export const skinQuestions: Record<string, SkinQuestion> = {
  start: {
    id: "start",
    title: "신경 쓰이는 부위가 어떤 상태인가요?",
    description: "가장 가까운 것을 하나 골라 주세요.",
    options: [
      { label: "만지면 도톰하게 튀어나와 있어요", hint: "점 · 쥐젖 · 사마귀 · 검버섯 등", next: "raised" },
      { label: "평평해서 만져지지는 않는 색소예요", hint: "기미 · 주근깨 · 잡티 등", next: "flat" },
      { label: "붉은기나 실핏줄이 신경 쓰여요", hint: "홍조 · 혈관 확장", result: "redness" },
      { label: "여드름이나 모공이 고민이에요", hint: "염증성 여드름 · 피지", result: "acne" },
    ],
  },
  raised: {
    id: "raised",
    title: "튀어나온 부위의 모양과 위치는 어떤가요?",
    description: "가장 비슷한 설명을 골라 주세요.",
    options: [
      { label: "갈색~검정색이고 경계가 뚜렷하며 수년째 그대로예요", hint: "점", next: "mole-warning" },
      { label: "목·겨드랑이·눈꺼풀에 말랑한 돌기가 있어요", hint: "쥐젖", result: "skin-tag" },
      { label: "살색의 납작한 돌기가 여러 개 생겼어요", hint: "편평사마귀 · 이마·볼·손등", result: "flat-wart" },
      { label: "눈 밑에 살색 알갱이가 단단하게 여러 개 만져져요", hint: "한관종 · 1~3mm", result: "syringoma" },
      { label: "눈가에 하얀 알갱이가 비쳐 보여요", hint: "비립종 · 1~2mm", result: "milium" },
      { label: "갈색이고 표면이 거칠거칠하며 40대 이후 늘었어요", hint: "검버섯", result: "seborrheic" },
    ],
  },
  flat: {
    id: "flat",
    title: "색소의 모양과 생긴 시기는 어떤가요?",
    description: "가장 비슷한 설명을 골라 주세요.",
    options: [
      {
        label: "광대·볼에 좌우 대칭으로 퍼진 흐린 갈색 얼룩이에요",
        hint: "기미 · 경계가 흐릿함",
        result: "melasma",
      },
      {
        label: "1~3mm 작은 점이 수십 개, 어릴 때부터 있었어요",
        hint: "주근깨 · 여름에 진해짐",
        result: "freckle",
      },
      {
        label: "3~10mm 경계가 뚜렷한 평평한 반점이 40대 이후 생겼어요",
        hint: "흑자 · 잡티",
        result: "lentigo",
      },
      {
        label: "여드름이나 상처가 있던 자리에 그 모양대로 남았어요",
        hint: "염증 후 색소침착",
        result: "pih",
      },
    ],
  ...
  "mole-warning": {
    id: "mole-warning",
    title: "혹시 다음 중 해당되는 것이 있나요?",
    description: "제거 전에 반드시 확인이 필요한 신호입니다.",
    options: [
      { label: "해당되는 것이 없어요", hint: "모양·크기가 오랫동안 그대로예요", result: "mole" },
      {
        label: "좌우 모양이 비대칭이거나 경계가 불규칙해요",
        hint: "진료 확인이 먼저 필요합니다",
        next: "mole-alert",
      },
      { label: "크기가 6mm(연필 지우개)보다 커요", hint: "진료 확인이 먼저 필요합니다", next: "mole-alert" },
      { label: "최근에 색이나 크기가 변했어요", hint: "진료 확인이 먼저 필요합니다", next: "mole-alert" },
    ],
  },
};
